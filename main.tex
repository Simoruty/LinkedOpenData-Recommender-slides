...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Configurazione ottimale - Micro Precision}
	\hspace{1.5cm}
	\begin{tikzpicture}
	\begin{axis}[
	legend style={
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Configurazione ottimale - Micro precision Epurata}
	\hspace{1.5cm}
	\begin{tikzpicture}
	\begin{axis}[
	legend style={
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Configurazione Nostra - Micro precision}	
	\hspace{1.5cm}
	\begin{tikzpicture}
	\begin{axis}[
	legend style={
...
\begin{frame}
	\frametitle{Configurazione Nostra - Micro precision Epurata}
	\hspace{1.5cm}
	\begin{tikzpicture}
	\begin{axis}[
	legend style={
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Configurazione Musto - Micro precision}	
	\hspace{1.5cm}
	\begin{tikzpicture}
	\begin{axis}[
	legend style={
...
\begin{frame}
	\frametitle{Configurazione musto - Micro precision Epurata}	
	\hspace{1.5cm}
	\begin{tikzpicture}
	\begin{axis}[
	legend style={
