...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Configurazione A - Micro precision}	
	\hspace{1.5cm}
	\begin{tikzpicture}
	\begin{axis}[
	legend style={
...
\begin{frame}
	\frametitle{Configurazione A - Micro precision Epurata}
	\hspace{1.5cm}
	\begin{tikzpicture}
	\begin{axis}[
	legend style={
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Configurazione B - Micro precision}	
	\hspace{1.5cm}
	\begin{tikzpicture}
	\begin{axis}[
	legend style={
...
\begin{frame}
	\frametitle{Configurazione B - Micro precision Epurata}	
	\hspace{1.5cm}
	\begin{tikzpicture}
	\begin{axis}[
	legend style={
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Configurazione C - Micro Precision}
	\hspace{1.5cm}
	\begin{tikzpicture}
	\begin{axis}[
	legend style={
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Configurazione C - Micro precision Epurata}
	\hspace{1.5cm}
	\begin{tikzpicture}
	\begin{axis}[
	legend style={
