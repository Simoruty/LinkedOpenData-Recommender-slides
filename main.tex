...
Attraverso query SPARQL\footnote{\emph{Endpoint} : \url{http://dbpedia.org}} sono state estratte tutte le triple RDF aventi come predicato una delle proprietà definite in precedenza. \\~\\
...
\begin{frame}
\frametitle{Grafo delle Risorse} 
Esempio di grafo delle risorse partendo dalle triple RDF estratte precedentemente. \\~\\
\begin{columns}[p]
