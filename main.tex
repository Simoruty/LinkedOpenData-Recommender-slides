...
\begin{frame}
	\frametitle{Raccomandazione}
	Al fine di velocizzare la fase di raccomandazione è stata creata una struttura dati hashmap atta a contenere tutte le tipologie di distanze con i relativi valori tra i film.
	Data la configurazione ( tipo profilo - Tipo distanza - Numero raccomandazioni)
	prelevare il tipo di profilo dall'utente.
	Accedere al mega hashmap in base al tipo di distanza
	in base ai film votati prelevare il numero k di raccomandazioni sempre dal mega hashmap.
\end{frame}
