...
%\begin{lstlisting}
%PREFIX dbpedia: \textless http://dbpedia.org/resource/ \textgreater
%PREFIX prop: \textless http://dbpedia.org/ontology/  \textgreater
%SELECT ?name
%WHERE {
...
\begin{frame}
\frametitle{Esempio}
\begin{tikzpicture}[scale=1.5, shape=circle,inner sep=1pt,draw,thick]
\foreach \pos/\name in {{(2,4)/a}, {(1,3)/b}, {(3,3)/c}, {(1,2)/d},
{(3,2)/e}, {(1,1)/f}}
        \node[vertex] (\name) at \pos {$\name$};
 \foreach \source/ \dest /\weight in {a/b/1, b/a/1, a/c/1, b/d/1, c/e/1, d/f/1}
